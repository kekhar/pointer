        ...
        <div className="mt-12 flex flex-col lg:flex-row gap-y-6 lg:gap-x-[60px] max-w-[1460px] mx-auto">
          ...
          <div className="flex-1 space-y-6">
            <div className="grid grid-cols-2 gap-x-4 gap-y-3">
              ...
              <button
                className="
            w-full py-[22px] pl-[22px]
            bg-[#3A86FF] text-white
            rounded-[16px] border-2 border-[#1455FF]
            flex items-center space-x-2 text-left

            text-[14px] sm:text-[16px] md:text-[18px] lg:text-[16px] xl:text-[18px]
            max-[1168px]:text-[14px]
            max-[1060px]:text-[12px]
            max-[438px]:text-[10px]
          ...
          "
              >
                ...
                <span className="flex-1 min-w-0 font-roboto whitespace-normal">
                  Указка
                </span>
              </button>
          ...
          "
              >
                ...
                >
                  ...
                  <g mask="url(#mask-uk-2)" fill="#FF6E23">
